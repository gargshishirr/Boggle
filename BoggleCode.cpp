...
int main(){ 
    ...
    cout<<" Welcome To My Project - 'BOGGLE!' "<<endl;
    ...
    TrieNode* temp=NULL;
    ifstream dictionary;
    dictionary.open("/Users/shishir/desktop/Boggle/english.txt");       // opening file containing all words,letters and abbreviations
    if(!dictionary){
        cout<<"Error Opening Dicitonary!"<<endl;
        return -1;
    }
    vector<string> words;
    int count=0;
    ...
    cout<<"\n\n";
    cout<<"Project made by Shishir Garg 2K21/CO/440"<<endl;
    delete temp;
    return 0;
}
